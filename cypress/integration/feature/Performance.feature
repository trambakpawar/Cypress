...
Scenario: Check the Configure KPI's page 
    ...
    When I click on the Configure tab and select the KPI's
    When I add the job to performance page
    When Job get added successfully
    When I search the job and delete it
